<template>
  <div class="help container px-0 px-md-3">
    <el-backtop></el-backtop>
    <div class="px-3 p-md-0">
      <el-row class="row-help">
        <el-col :span="24" class="col-help mt-4">
          <el-tabs v-model="itemTab" tab-position="left">
            <el-tab-pane label="关于我们" name="关于我们">
              <p>
            ...
            <el-tab-pane label="用户协议" name="用户协议">
              <p>
            ...
            <el-tab-pane label="免责声明" name="免责声明">
              <p>
